...
--
-- Host: localhost    Database: chlenobot
-- ------------------------------------------------------
...
CREATE TABLE `poll` (
  ...
  `type` char(255) COLLATE utf8mb4_unicode_520_ci DEFAULT NULL COMMENT 'Poll type, currently can be âregularâ or âquizâ',
...
CREATE TABLE `telegram_update` (
  ...
  `chat_member_updated_id` bigint unsigned DEFAULT NULL COMMENT 'A chat member''s status was updated in a chat. The bot must be an administrator in the chat and must explicitly specify âchat_memberâ in the list of allowed_updates to receive these updates.',
...
-- Dump completed on 2022-06-07 16:02:46
